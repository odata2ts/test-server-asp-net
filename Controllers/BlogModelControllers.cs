...
// This file contains various Controllers which expose OData endpoints.
// Asp net odata is a thin layer on top of Asp net. In order to register an odata endpoint, you must:
//  1. Create a controller (or add a method to an exsiting one)
//  2. Register that endpoint with OData (Program.GetEdmModel)
