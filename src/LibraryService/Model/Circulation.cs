...
/// <summary>
/// Carrier of the spatial types and of the flags enum - and the one entity whose key the *client*
/// assigns: a branch code the organisation allocates, not a row number the database hands out. So it
/// carries no managed annotation, which is what makes it the counter-example to every key that does.
/// The reference model names it as such; see the design decisions in its library.md.
/// </summary>
public class Branch
{
    public int Id { get; set; }
